...
Sub Setup_king_of_the_hill()
  ...
  'Memory positions necessary to save to FRAM:
  ' Bit Count  |  Description
  ' 8             Game Type
  ' 80            Save Name
  ' 8             Loc_radius
  ' 1             View Friendly
  ' 3             View Enemy (View Always, Camping, Firing, Camp+Firing, Never)
  ' 16            Game Length
  ' 16            Timeout Length
  ' 32            Team A Start Location
  ' 32            Team B Start Location
  ' 32            Hill Location
  ' 128           Border Locations
  ' 8             Field Feature Count
  ' 8 x n         Feature Type
  ' 32 x n        Feature Location
  '====================================
  '~ 512 bits/save
